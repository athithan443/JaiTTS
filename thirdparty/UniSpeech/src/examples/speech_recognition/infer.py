...
from thirdparty.UniSpeech.src.fairseq import checkpoint_utils, options, progress_bar, utils
sys.path.append(os.getcwd())

import editdistance
import numpy as np
import torch
from thirdparty.UniSpeech.src.fairseq import tasks
from thirdparty.UniSpeech.src.fairseq.data.data_utils import post_process
from thirdparty.UniSpeech.src.fairseq.dataclass.utils import convert_namespace_to_omegaconf
from thirdparty.UniSpeech.src.fairseq.logging.meters import StopwatchMeter, TimeMeter
...
def main(args, task=None, model_state=None):
    ...
    def build_generator(args):
        ...
        if w2l_decoder == "viterbi":
            from thirdparty.UniSpeech.src.examples.speech_recognition.w2l_decoder import W2lViterbiDecoder

            return W2lViterbiDecoder(args, task.target_dictionary)
        elif w2l_decoder == "transducer":
            from thirdparty.UniSpeech.src.examples.speech_recognition.w2l_decoder import TransducerDecoder
            return TransducerDecoder(args, task.target_dictionary)
        elif w2l_decoder == "kenlm":
            from thirdparty.UniSpeech.src.examples.speech_recognition.w2l_decoder import W2lKenLMDecoder

            return W2lKenLMDecoder(args, task.target_dictionary)
        elif w2l_decoder == "fairseqlm":
            from thirdparty.UniSpeech.src.examples.speech_recognition.w2l_decoder import W2lFairseqLMDecoder
