...
from thirdparty.UniSpeech.src.fairseq.tasks.audio_pretraining import AudioPretrainingTask
...
from thirdparty.UniSpeech.src.fairseq.models.wav2vec.wav2vec2 import Wav2Vec2Config, Wav2Vec2Model
from thirdparty.UniSpeech.src.fairseq.models.wav2vec.wav2vec2_asr import Linear
