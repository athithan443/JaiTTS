...
from thirdparty.UniSpeech.src.fairseq.data.data_utils import compute_mask_indices
from thirdparty.UniSpeech.src.fairseq.data.dictionary import Dictionary
from thirdparty.UniSpeech.src.fairseq.dataclass import ChoiceEnum, FairseqDataclass
from thirdparty.UniSpeech.src.fairseq.models import BaseFairseqModel, register_model
from thirdparty.UniSpeech.src.fairseq.models.unispeech_sat.unispeech_sat import (
    ConvFeatureExtractionModel,
    TransformerSentenceEncoderLayer,
)
from thirdparty.UniSpeech.src.fairseq.modules import (
    Fp32GroupNorm,
    Fp32LayerNorm,
    GradMultiply,
    LayerNorm,
...
from thirdparty.UniSpeech.src.fairseq.tasks.utterance_mixing_pretraining import (
    UtteranceMixingPretrainingConfig,
    UtteranceMixingPretrainingTask,
)
from thirdparty.UniSpeech.src.fairseq.models.wav2vec.wav2vec2 import init_bert_params
from thirdparty.UniSpeech.src.fairseq.utils import index_put, buffered_arange
