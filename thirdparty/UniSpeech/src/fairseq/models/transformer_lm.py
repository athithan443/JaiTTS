...
from thirdparty.UniSpeech.src.fairseq.models.transformer import (
    DEFAULT_MIN_PARAMS_TO_WRAP, Embedding, TransformerDecoder
)
from thirdparty.UniSpeech.src.fairseq.modules import AdaptiveInput, CharacterTokenEmbedder
from omegaconf import II
from thirdparty.UniSpeech.src.fairseq import options
