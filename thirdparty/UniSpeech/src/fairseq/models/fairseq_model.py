...
from thirdparty.UniSpeech.src.fairseq.data import Dictionary
...
class BaseFairseqModel(nn.Module):
    ...
    def load_state_dict(
        ...
        from thirdparty.UniSpeech.src.fairseq.checkpoint_utils import prune_state_dict
        ...
        *generator.models* attribute.
        ...
        Args:
            ...
            data_name_or_path (str, optional): point args.data to the archive
                ...
                model archive path.
        """
        from thirdparty.UniSpeech.src.fairseq import hub_utils
