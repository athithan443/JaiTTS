...
import math
import numpy as np
from thirdparty.UniSpeech.src.fairseq import checkpoint_utils, utils
import torch
...
from thirdparty.UniSpeech.src.fairseq.models import (
    BaseFairseqModel,
    FairseqEncoder,
...
from thirdparty.UniSpeech.src.fairseq.models.wav2vec.wav2vec2 import MASKING_DISTRIBUTION_CHOICES
