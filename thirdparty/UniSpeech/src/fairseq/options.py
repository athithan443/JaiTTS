...
from thirdparty.UniSpeech.src.fairseq.data.indexed_dataset import get_available_dataset_impl
from thirdparty.UniSpeech.src.fairseq.dataclass.configs import (
    CheckpointConfig,
    CommonConfig,
    CommonEvalConfig,
    DatasetConfig,
...
from thirdparty.UniSpeech.src.fairseq.utils import csv_str_list, eval_bool, eval_str_dict, eval_str_list  # noqa
...
def parse_args_and_arch(
    ...
    from thirdparty.UniSpeech.src.fairseq.models import ARCH_MODEL_REGISTRY, ARCH_CONFIG_REGISTRY, MODEL_REGISTRY
    ...
    if hasattr(args, "task"):
        from thirdparty.UniSpeech.src.fairseq.tasks import TASK_REGISTRY

        TASK_REGISTRY[args.task].add_args(parser)
    if getattr(args, "use_bmuf", False):
        # hack to support extra args for block distributed data parallelism
        from thirdparty.UniSpeech.src.fairseq.optim.bmuf import FairseqBMUF

        FairseqBMUF.add_args(parser)

    # Add *-specific args to parser.
    from thirdparty.UniSpeech.src.fairseq.registry import REGISTRIES
...
def add_model_args(parser):
    ...
    from thirdparty.UniSpeech.src.fairseq.models import ARCH_MODEL_REGISTRY
