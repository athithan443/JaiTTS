...
import numpy as np
import torch
from thirdparty.UniSpeech.src.fairseq.dataclass.constants import DATASET_IMPL_CHOICES
from thirdparty.UniSpeech.src.fairseq.data.fasta_dataset import FastaDataset
...
def make_dataset(path, impl, fix_lua_indexing=False, dictionary=None):
    if impl == "raw" and IndexedRawTextDataset.exists(path):
        ...
        from thirdparty.UniSpeech.src.fairseq.data.fasta_dataset import EncodedFastaDataset
