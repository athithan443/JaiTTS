...
from thirdparty.UniSpeech.src.fairseq import file_utils
from thirdparty.UniSpeech.src.fairseq.data.encoders import register_bpe
from thirdparty.UniSpeech.src.fairseq.data.encoders.byte_utils import (
    SPACE,
    SPACE_ESCAPE,
    byte_encode,
    smart_byte_decode,
