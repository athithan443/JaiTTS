...
from thirdparty.UniSpeech.src.fairseq import checkpoint_utils, models, utils
from thirdparty.UniSpeech.src.fairseq.logging import meters
import torch
from thirdparty.UniSpeech.src.fairseq import optim
from thirdparty.UniSpeech.src.fairseq.dataclass.configs import FairseqConfig
from thirdparty.UniSpeech.src.fairseq.dataclass.utils import convert_namespace_to_omegaconf
from thirdparty.UniSpeech.src.fairseq.distributed import utils as distributed_utils
from thirdparty.UniSpeech.src.fairseq.file_io import PathManager
from thirdparty.UniSpeech.src.fairseq.logging import metrics
from thirdparty.UniSpeech.src.fairseq.nan_detector import NanDetector
from thirdparty.UniSpeech.src.fairseq.optim import lr_scheduler
...
class Trainer(object):
    ...
    def __init__(self, cfg: FairseqConfig, task, model, criterion, quantizer=None):
        ...
        self._dummy_batch = "DUMMY" #None  # indicates we don't have a dummy batch at first
            ...
            try:
                with maybe_no_sync():
                    ...
                    if self.cfg.common.fp16:
                        sample['loss_scale'] = self.optimizer.scaler.loss_scale
    ...
    def get_meter(self, name):
        ...
        from thirdparty.UniSpeech.src.fairseq import meters
    ...
    def _xla_markstep_and_send_to_cpu(self, data=None):
        ...
        xm.mark_step()
        if data is not None:
            from thirdparty.UniSpeech.src.fairseq.utils import xla_device_to_cpu
