...
def add_defaults(cfg: DictConfig) -> None:
    ...
    from thirdparty.UniSpeech.src.fairseq.models import ARCH_MODEL_NAME_REGISTRY, MODEL_DATACLASS_REGISTRY
    from thirdparty.UniSpeech.src.fairseq.dataclass.utils import merge_with_parent
