...
def override_module_args(args: Namespace) -> Tuple[List[str], List[str]]:
    ...
    if args is not None:
        if hasattr(args, "task"):
            from thirdparty.UniSpeech.src.fairseq.tasks import TASK_DATACLASS_REGISTRY
        ...
        if hasattr(args, "arch"):
            from thirdparty.UniSpeech.src.fairseq.models import ARCH_MODEL_REGISTRY, ARCH_MODEL_NAME_REGISTRY
...
def convert_namespace_to_omegaconf(args: Namespace) -> DictConfig:
    ...
    if cfg.optimizer is None and getattr(args, "optimizer", None):
        ...
        from thirdparty.UniSpeech.src.fairseq.optim import OPTIMIZER_REGISTRY
    ...
    if cfg.lr_scheduler is None and getattr(args, "lr_scheduler", None):
        ...
        from thirdparty.UniSpeech.src.fairseq.optim.lr_scheduler import LR_SCHEDULER_REGISTRY
    ...
    if cfg.criterion is None and getattr(args, "criterion", None):
        ...
        from thirdparty.UniSpeech.src.fairseq.criterions import CRITERION_REGISTRY
