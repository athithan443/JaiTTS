...
from thirdparty.UniSpeech.src.fairseq.dataclass.configs import DistributedTrainingConfig, FairseqConfig
...
def distributed_init(cfg: FairseqConfig):
    ...
    if cfg.common.model_parallel_size > 1:
        raise ValueError("Unsupport for model_parallel_size > 1")
