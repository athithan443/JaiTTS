...
import os
import sys
from thirdparty.UniSpeech.src.fairseq.data import AddTargetDataset, ConcatDataset, Dictionary, FileAudioDataset, ResamplingDataset
import torch
...
from thirdparty.UniSpeech.src.fairseq.dataclass.configs import GenerationConfig
