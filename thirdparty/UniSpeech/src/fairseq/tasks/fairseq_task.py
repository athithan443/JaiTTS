...
from thirdparty.UniSpeech.src.fairseq import metrics, search, tokenizer
from thirdparty.UniSpeech.src.fairseq.data import Dictionary, FairseqDataset, data_utils, iterators
import torch
from thirdparty.UniSpeech.src.fairseq import utils
from thirdparty.UniSpeech.src.fairseq.data import encoders
from thirdparty.UniSpeech.src.fairseq.dataclass import FairseqDataclass
from thirdparty.UniSpeech.src.fairseq.dataclass.utils import gen_parser_from_dataclass
from thirdparty.UniSpeech.src.fairseq.optim.amp_optimizer import AMPOptimizer
...
class FairseqTask(object):
    ...
    def dataset(self, split):
        ...
        """
        from thirdparty.UniSpeech.src.fairseq.data import FairseqDataset
    ...
    def build_model(self, cfg: FairseqDataclass):
        ...
        """
        from thirdparty.UniSpeech.src.fairseq import models
    ...
    def build_criterion(self, cfg: DictConfig):
        ...
        """
        from thirdparty.UniSpeech.src.fairseq import criterions
    ...
    def build_generator(
        ...
        if getattr(args, "score_reference", False):
            from thirdparty.UniSpeech.src.fairseq.sequence_scorer import SequenceScorer
        ...
        from thirdparty.UniSpeech.src.fairseq.sequence_generator import (
            SequenceGenerator,
