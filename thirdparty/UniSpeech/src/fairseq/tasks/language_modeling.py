...
import numpy as np
from thirdparty.UniSpeech.src.fairseq.data import Dictionary, IdDataset, MonolingualDataset
import torch
from thirdparty.UniSpeech.src.fairseq import utils
from thirdparty.UniSpeech.src.fairseq.data import (
    #AppendTokenDataset,
    data_utils,
)
from thirdparty.UniSpeech.src.fairseq.data.indexed_dataset import get_available_dataset_impl
from thirdparty.UniSpeech.src.fairseq.data.shorten_dataset import maybe_shorten_dataset
from thirdparty.UniSpeech.src.fairseq.dataclass import ChoiceEnum, FairseqDataclass
from thirdparty.UniSpeech.src.fairseq.tasks import LegacyFairseqTask, register_task
